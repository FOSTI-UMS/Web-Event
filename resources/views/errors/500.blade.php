...
<head>
    ...
    <title>Error - Forum Open Source Teknik Informatika UMS</title>
...
<body>
	...
	<nav class="nav-wrper fixed green darken-2" style="top: 0 !important;">
		<div class="container">
			...
			<ul class="right hide-on-med-and-down">
				...
				<li><a title="Event Fosti" href="http://fosti.ums.ac.id">Fosti</a></li>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 col-md-offset-4 center-align" style="margin-top: 200px;">
                <div>
                    <h1>Hayoo, mau ngapain lu bro :(</h1>
                    <p>Kontak admin aja deh mnding :).</p>
                </div>
                <div class="center-align">
                    <a href="http://event.fostiums.org" class="btn btn-primary green">Back to Hompage</a>
                </div>
            </div>
        </div>
    </div>
    <footer class="page-footer green lighten-1" style="position: absolute; width: 100%; bottom: 0;">
