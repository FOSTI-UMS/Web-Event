	...
	<div class="menu">
		...
		<section class="section register">
			<div class="container valid">
				<div class="row">
					<div class="col s12 center-align">
						<h4 class="green-text">PERMOHONAN REGISTRASI BERHASIL</h4>
				...
				<br/><center><h6 class="red-text"><strong>Silahkan cek E-Mail masuk anda dan klik konfirmasi untuk verifikasi pendaftaran</strong></h5></center>
				<div class="row">
					<div class="col s12 center-align">
